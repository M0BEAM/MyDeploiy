...
interface ApplicationUiDeployWebProps {
  children: ReactNode;
}
export default function ApplicationUiDeployWeb({ children }: ApplicationUiDeployWebProps) {
  const pathName = usePathname ();
  const params = useParams();
  const { id } = params; // Access the dynamic `id` from the URL
  const currentPath = "/dashboard/deploy/web"
