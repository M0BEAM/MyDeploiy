      ...
      <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4 md:col-span-12 lg:col-span-4">
            <Image src="/assets/logoApp.png" alt="logo" width={160} height={48} className="pb-8" />
            <div className="flex gap-4">
              <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="footer-fb-icons">
                <Image src="/assets/footer/facebook.svg" alt="facebook" width={15} height={20} />
              </Link>
              <Link href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="footer-icons">
                <Image src="/assets/footer/twitter.svg" alt="twitter" width={20} height={20} />
              </Link>
              <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="footer-icons">
          ...
          <div className="col-span-4 md:col-span-4 lg:col-span-4">
            <div className="flex gap-2">
              ...
              <h5 className="text-base font-normal text-offwhite">Monastir Tunisia 5000</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Image src="/assets/footer/telephone.svg" alt="telephone-icon" width={24} height={24} />
              <h5 className="text-base font-normal text-offwhite">+ 216 12 345 678</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Image src="/assets/footer/email.svg" alt="email-icon" width={24} height={24} />
              <h5 className="text-base font-normal text-offwhite">myDeploy@gmail.com</h5>
            </div>
          </div>
        </div>
        ...
        <div className="py-10 lg:flex items-center justify-between border-t border-t-bordertop">
          <h4 className="text-offwhite text-sm text-center lg:text-start font-normal">
            ...
            <Link href="https://adminmart.com/" target="_blank" rel="noopener noreferrer">
              myDeploy
            </Link>
          </h4>
